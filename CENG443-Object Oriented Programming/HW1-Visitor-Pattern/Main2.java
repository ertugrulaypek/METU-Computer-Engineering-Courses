...
public class Main2 {
    ...
    public static void main(String[] args) {
        ...
        MathExpression me = small1;
        
        CountAtomicsVisitor vs = new CountAtomicsVisitor();
        
//        System.out.println("The count of numerics is: " + me.accept(vs));
...
//        System.out.println("The match should be true with testexp since it is the first match: " + Boolean.toString(testvar.match(testexp)));
        Op testexp2 = new Op("/",new Op("+",new Sym("x"),new Num(3)), new Num(3));
        Op testexp3 = new Op("/",new Op("+",new Sym("x"),new Num(3)), new Num(2));
//        System.out.println("The match should be true with testexp2 since it is the second match: " + Boolean.toString(testvar.match(testexp2)));
//        System.out.println("The match should be false with testexp3 since it is the third match: " + Boolean.toString(testvar.match(testexp3)));
