...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        StudyGroup bros = new StudyGroup("bros", mera);
        StudyGroup sisters = new StudyGroup("sisters", mera);
        
        StudyGroup[] studyGroups = {quietOnes,ruleBreakers,seniorProjectProgrammers,slackers, bros, sisters};
